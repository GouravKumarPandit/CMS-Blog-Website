...
class BlogController extends Controller{
    ...
    public function store(Request $request){
        ...
        if ($request->file('image')) {
            ...
            $imagePath = $request->file('image')->storeAs('/blogs/post/images', $filename, 'public');
        }
        ...
        return redirect()->route('home.mypost')->with('status','Post Saved successfully');
    ...
    public function update(Request $request, Post $post){
        ...
        return redirect()->route('home.mypost')->with('status','Post Updated successfully');
    }
